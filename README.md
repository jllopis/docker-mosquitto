...
You can specify your repository and tag by
    ...
    $ sudo make REPOSITORY=my_own_repo/mqtt TAG=v1.4.7

Default for **REPOSITORY** is **jllopis/mosquitto** (should change this) and for **TAG** is **mosquitto version (1.4.7 now)**.
